...
class Container_4a9ed71ce9 extends _PHPStan_24e2736d6\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/Users/rhyslees/Code/Packages/codebar-ag/filament-revealable-field']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'phar:///Users/rhyslees/Code/Packages/codebar-ag/filament-revealable-field/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_4a9ed71ce9 $container)
			{
	...
	public function createServiceContainer(): Container_4a9ed71ce9
	{
		return $this;
	}
