...
class Container_0239a5a612 extends _PHPStan_e52dec71a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_0239a5a612 $container)
			{
	...
	public function createServiceContainer(): Container_0239a5a612
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['/Users/rhyslees/Code/Packages/codebar-ag/filament-revealable-field/src'],
			'exceptions' => [
				'implicitThrows' => true,
