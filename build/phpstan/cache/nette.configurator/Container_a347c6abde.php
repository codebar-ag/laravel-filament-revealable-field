...
class Container_a347c6abde extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0245' => true, '0518' => true],
		'phpstan.rules.rule' => [
			'0315' => true,
			'0319' => true,
			'0320' => true,
		...
		'phpstan.deprecations.deprecatedScopeResolver' => ['0515' => true],
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0519' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0245', '0518']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0467', '0468', '0475', '0477', '0516']],
		...
		'PHPStan\Rules\Deprecations\DeprecatedClassHelper' => [['0512']],
		'PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider' => [['0513']],
		'PHPStan\Rules\Deprecations\DeprecatedScopeHelper' => [['0514']],
		'PHPStan\Rules\Deprecations\DeprecatedScopeResolver' => [['0515']],
		'PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver' => [['0515']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0516']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0516']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0517']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0518']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0519']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0519']],
		'PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension' => [['0520']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0521']],
		'PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension' => [['0522']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0523']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0524']],
		'PHPStan\Rules\PHPUnit\DataProviderHelper' => [['0525']],
		'PHPStan\Rules\PHPUnit\DataProviderHelperFactory' => [['0526']],
		'PHPStan\Rules\PHPUnit\ClassCoversExistsRule' => [['0527']],
		'PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule' => [['0528']],
		'PHPStan\Rules\PHPUnit\DataProviderDeclarationRule' => [['0529']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule' => [['0530']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule' => [['0531']],
	];
	...
	public function createService022(): PHPStan\Php\PhpVersionFactoryFactory
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(
			null,
			[
				'/Users/rhyslees/Code/Packages/codebar-ag/filament-revealable-field/vendor/phpstan/phpstan/..',
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a347c6abde $container)
			{
	...
	public function createService0512(): PHPStan\Rules\Deprecations\DeprecatedClassHelper
	{
		return new PHPStan\Rules\Deprecations\DeprecatedClassHelper($this->getService('reflectionProvider'));
	}


	public function createService0513(): PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider
	{
		return new PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider($this->getService('061'));
	}


	public function createService0514(): PHPStan\Rules\Deprecations\DeprecatedScopeHelper
	{
		return $this->getService('0513')->get();
	}


	public function createService0515(): PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver
	{
		return new PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver;
	}


	public function createService0516(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0517(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0518(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0519(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0520(): PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension;
	}


	public function createService0521(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0522(): PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension;
	}


	public function createService0523(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0524(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0525(): PHPStan\Rules\PHPUnit\DataProviderHelper
	{
		return $this->getService('0526')->create();
	}


	public function createService0526(): PHPStan\Rules\PHPUnit\DataProviderHelperFactory
	{
		return new PHPStan\Rules\PHPUnit\DataProviderHelperFactory($this->getService('reflectionProvider'), $this->getService('0154'));
	}


	public function createService0527(): PHPStan\Rules\PHPUnit\ClassCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassCoversExistsRule($this->getService('0523'), $this->getService('reflectionProvider'));
	}


	public function createService0528(): PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule($this->getService('0523'), $this->getService('0154'));
	}


	public function createService0529(): PHPStan\Rules\PHPUnit\DataProviderDeclarationRule
	{
		return new PHPStan\Rules\PHPUnit\DataProviderDeclarationRule($this->getService('0525'), false, true);
	}


	public function createService0530(): PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule($this->getService('0524'));
	}


	public function createService0531(): PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule($this->getService('0524'));
	}
	...
	public function createServiceContainer(): Container_a347c6abde
	{
		return $this;
	}
	...
	{
		return new PHPStan\Rules\Deprecations\UsageOfDeprecatedCastRule($this->getService('0514'));
	}
