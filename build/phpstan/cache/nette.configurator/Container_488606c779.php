...
class Container_488606c779 extends _PHPStan_e52dec71a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_488606c779 $container)
			{
	...
	public function createServiceContainer(): Container_488606c779
	{
		return $this;
	}
